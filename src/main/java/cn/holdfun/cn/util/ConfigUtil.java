...
public class ConfigUtil {
	 ...
	 * 
	 * @param key
	 * @return the value in this property list with the specified key value. If the key is not found, return an empty string "".
	 */
	...
	public static void setContextAbsoultePath(String contextAbsoultePath) {
		ConfigUtil.contextAbsoultePath = contextAbsoultePath;
	}

	/**
	 * Get the application context logical path. It is equals to request.getContextPath().
	 * 
	 * @return String
	 */
